...
class DatabaseConnection(metaclass=Singleton):
    ...
    def do_connection(self):
        ...
        try:
            cnx = mysql.connector.connect(user=os.environ['DB_USER'], password=os.environ['DB_PWD'],
                                          host=os.environ['DB_HOST'], database=os.environ['DB_NAME'], port=os.environ['DB_PORT'])
            print("==== DB CONNECTED ====")
            self.cnx = cnx
